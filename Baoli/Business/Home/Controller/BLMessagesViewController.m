...
#import "BLMessagesCell.h"
@interface BLMessagesViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
{
    static NSString *identify = @"BLMessagesCell";
    BLMessagesCell *cell = [tableView dequeueReusableCellWithIdentifier:identify];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"BLMessagesCell" owner:nil options:nil] firstObject];
    }
    return cell;
